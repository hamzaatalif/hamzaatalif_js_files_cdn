document.addEventListener("DOMContentLoaded", () => {
    ...
    let allGettingInputs = [
        getting_firstNameInput,
        getting_lastNameInput,
        getting_emailInput,
        getting_phoneInput,
        getting_first_streetAddressInput,
        getting_second_streetAddressInput,
        getting_cityInput,
        getting_stateInput,
        getting_zipInput,
        getting_countryInput,
        getting_yearInput,
        getting_makeInput,
        getting_modelInput,
        getting_registeredLengthInput,
        getting_engineMakeInput,
        getting_engineHorsepowerInput
    ]
